...
const Footer = () => {
  return (
    <div className="fixed bottom-0 left-0 w-full z-50">
      <footer className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-2 px-4 shadow-md flex flex-col items-center">
        <div className="flex items-center space-x-2">
          ...
          <p className="text-sm font-semibold">DevTinder</p>
        </div>

        <p className="text-xs opacity-80">© {new Date().getFullYear()} All rights reserved.</p>
          ...
          {["Twitter", "GitHub", "LinkedIn", "YouTube"].map((icon, i) => (
            <a key={i} href="#" className="hover:scale-105 transition">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" className="fill-current">
                {/* You can replace these paths with respective icons as needed */}
